...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lista 2 - Exercicio 1", nullptr, nullptr);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		5,  5, 0.0f, 1.0, 0.0, 0.0, //Superior esquerdo
		5, -5, 0.0f, 0.0, 1.0, 0.0, //Inferior esquerdo
	   -5,  5, 0.0f, 0.0, 0.0, 1.0, //Superior esquerdo

		5, -5, 0.0f, 1.0, 1.0, 0.0,
	   -5, -5, 0.0,  1.0, 0.0, 1.0,  //Inferior esquerdo
	   -5,  5, 0.0f, 0.0, 1.0, 1.0
	};
